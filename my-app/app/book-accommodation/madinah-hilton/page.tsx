...
export default function BookingPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      router.push("/book-accommodation/madinah-hilton/success")
    }, 1500)
  }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="space-y-6">
          <div className="rounded-lg overflow-hidden">
            <Image
              src="https://mj-ahmad.github.io/mja2025/img/hilton00.png"
              alt="Hilton Madinah"
              width={600}
              height={400}
          ...
          <div className="space-y-4">
            <h1 className="text-3xl font-bold">Hilton Madinah</h1>
            ...
            <p className="text-gray-600">
              Experience world-class hospitality at Hilton Madinah, ideally located just steps away from the Prophet's
              Mosque. This elegant hotel offers spacious rooms with modern amenities, multiple dining options, and
              exceptional service to make your stay in the holy city comfortable and memorable.
            </p>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <p className="text-sm text-gray-600">Guest Room, Executive, Suite</p>
              </div>
              <div className="bg-gray-50 p-3 rounded-lg">
                <h3 className="font-medium">Amenities</h3>
                <p className="text-sm text-gray-600">Free WiFi, Restaurant, Fitness Center</p>
              </div>
              <div className="bg-gray-50 p-3 rounded-lg">
                <h3 className="font-medium">Price Range</h3>
                <p className="text-sm text-gray-600">$180-$400 per night</p>
              </div>
            </div>
          </div>
        </div>
